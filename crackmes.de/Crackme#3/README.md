...
I decided to use bruteforce to do it, because even if there might be smarter and more efficient algorithms to invert the logic, bruteforce is really simple and it takes seconds (or less) anyways, the bruteforcing stuff is provided in the solution.py script
